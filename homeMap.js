...
async function loadHomeObservations() {
    ...
    const baseUrl = 'https://www.butterflyexplorers.com/p/new-butterflies.html';
    
    try {
        if (loadingDiv) loadingDiv.textContent = 'Fetching data...';
        
        // Try corsproxy.io directly
        ...
        const allObservations = extractObservations(html, baseUrl);
        
        observations = allObservations;
        
        if (loadingDiv) {
            loadingDiv.textContent = `✅ Loaded ${observations.length} observations!`;
        ...
        if (loadingDiv) {
            loadingDiv.textContent = '❌ Failed: ' + error.message;
        }
    }
