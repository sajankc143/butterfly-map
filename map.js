// Global variables for map
            ...
            mapObservations.forEach(obs => {
                const popupContent = `
                    <div>
                        ...
                        ${obs.thumbnailUrl ? `<img src="${obs.thumbnailUrl}" class="popup-image" alt="${obs.species}" onerror="this.style.display='none'">` : ''}
                        ...
                        <div class="popup-date">🔗 ${obs.sourcePage}</div>
                    </div>
                `;
        ...
        class ButterflyInfiniteGalleryUpdater {
            ...
            // New method to update map from current page images
